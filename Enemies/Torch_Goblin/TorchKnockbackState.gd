...
func enter():
	...
	torch_character.speed = 0
	torch_character.direction = Vector2.ZERO
	knockback_to_apply = parameters.knockback_force
	torch_character.knockback = knockback_to_apply
...
func physics_update(delta : float):
	#print("Knockback: ", knockback_to_apply, " -  velocity: ", torch_character.velocity)
